...
const ITENS_MENU = [
  ...
  { label: 'Notas', to: '/notas', icon: ScrollText },
 ...
 *
 * Todos os itens agora tem rota propria (mesmo que a pagina em si ainda
 * seja so um Placeholder - ver pages/Vendas.jsx e afins) - por isso o
 * antigo mecanismo de item "desabilitado com 'em breve'" foi removido.
 */
